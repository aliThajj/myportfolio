...
import { Code2, Github, Mail, User } from 'lucide-react';
import AOS from 'aos';
          ...
          <div className="relative min-h-screen flex items-center justify-center px-4">
            <div className="w-full max-w-4xl mx-auto">
              ...
              <motion.div 
                ...
                variants={childVariants}>
                <h1 className="text-3xl sm:text-4xl md:text-6xl md:!leading-tight font-bold space-y-2 sm:space-y-4">
              ...
              <motion.div 
                ...
                data-aos-delay="1200">
                <a
                  href="mailto:alihajjhussein63@gmail.com"
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl"> <Mail className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-600" />
                    <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                      <TypewriterEffect text="alihajjhussein63@gmail.com" />
                    </span>
                  </div>
                </a>
              </motion.div>
